window.onload = async function(){
    ...
    var link = "https://agriculture.cosplane.asia/api/User/Users";
    if(token != null){
    ...
    if(repone.ok){
        ...
        list.forEach(element => {
            document.getElementById("tbodyy").innerHTML += "<tr><td>"+ element.fullname +"</td><td>"+ element.email +"</td><td>"+ element.phone  +"</td><td>"+ element.Address  +"</td><td>"+ element.isActivated +"</td><td>"+ "<button  class='btn btn-light' onclick='detail("+ JSON.stringify(element.userId) +")'>Detail</button>" +"</td></tr>"
        });
...
function detail(id){
  location.replace("DetailUser.html?id="+id);
}
function $(selector) {
